<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="inline-block overflow-hidden min-w-full rounded-lg shadow">
            ...
            <table class="w-full whitespace-no-wrap" v-if='histories.data.length > 0'>
                <thead>
                ...
                <tbody>
                <tr v-for="history in histories.data" :key="history.id" class="text-gray-700">
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                        <p class="text-gray-900 whitespace-no-wrap">{{ history.address }}</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                        <p class="text-gray-900 whitespace-no-wrap">{{ history.reason }}</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                        <p class="text-gray-900 whitespace-no-wrap">{{ history.last_donate }}</p>
                    </td>
