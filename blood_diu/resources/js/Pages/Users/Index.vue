        ...
        <div class="inline-block overflow-hidden min-w-full rounded-lg shadow">
            ...
            <div class="inline-flex overflow-hidden w-full bg-white rounded-lg shadow-md">
                ...
                <div class="px-4 py-2 -mx-3">
                    <div class="mx-3">
                        ...
                        <p class="text-sm text-gray-600">Donors Info</p>
                    </div>
                </div>
            </div>
            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tr v-for="user in users.data" :key="user.id" class="text-gray-700">
                    ...
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                        <p class="text-gray-900 whitespace-no-wrap">{{ user.blood_group }}</p>
                    </td>
                     <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                        <p class="text-gray-900 whitespace-no-wrap">{{ user.vaccinated_status?'Yes':'false' }}</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                        <p class="text-gray-900 whitespace-no-wrap">{{user.last_donate?user.last_donate:'No Donated Yet'}}</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
